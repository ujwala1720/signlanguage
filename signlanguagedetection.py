...
if app_mode =='About App':
    st.title('Medbot.AI')
    st.markdown('"MedBot.ai revolutionizes healthcare accessibility with cutting-edge sign language detection. Our web application seamlessly interprets sign language, enhancing communication between healthcare providers and individuals with hearing impairments. Bridging the gap for inclusive and patient-centered care, MedBot.ai ensures a more empathetic and efficient healthcare experience."')
    st.markdown(
    """
    <style>
    [data-testid="stSidebar"][aria-expanded="true"] > div:first-child {
